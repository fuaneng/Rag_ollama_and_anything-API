...
def get_details():
    ...
    try:
        ...
        print("Failed to decode JSON response:", result2.stdout)
    ...
    # 返回仅包含"textResponse"字段的响应-和-返回成功提示信息
    # {"success"True/False:,"data":"xxx","msg":"xxx"} 成功的话显示，失败的
    success_message = "恭喜你，数据处理成功！"
    response_data = {
        "text_response": text_response,
        "message": success_message # 添加成功提示信息
    }
    # 设置正确的字符编码为utf-8
